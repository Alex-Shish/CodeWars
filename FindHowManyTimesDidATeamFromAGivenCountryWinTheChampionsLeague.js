...
function countWins(winnerList, country) {
    return winnerList.filter(winnerList => country === winnerList['country']).length
}
...
console.log(countWins(winnerList, 'FootLand')); // 0
console.log(countWins(winnerList, 'Spain')); // 9