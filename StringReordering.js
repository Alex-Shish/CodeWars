...
Example
Input: List = [{'4': 'dog' }, {'2': 'took'}, {'3': 'his'},{'-2': 'Vatsan'}, {'5': 'for'}, {'6': 'a'}, {'12': 'spin'}]
Output: 'Vatsan took his dog for a spin'
 */

const sentence = List =>
    List.sort((a, b) => Object.keys(a)[0] - Object.keys(b)[0]).map(el => el[Object.keys(el)[0]]).join(' ')
