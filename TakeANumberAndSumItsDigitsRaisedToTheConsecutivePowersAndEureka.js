...
Instructions:
The number 898989 is the first integer with more than one digit that fulfills the property partially introduced
...
[a,b][a, b][a,b] (inclusive) and outputs a list of the sorted numbers in the range that fulfills the property
described above.
Examples
...
function sumDigPow(a, b) {
    let arr = [];
    while(a <= b){
        if(a.toString().split('').reduce((acc, cur, i) => acc + cur ** (i + 1), 0) == a) {
            arr.push(a)
        }
        a++
    }
