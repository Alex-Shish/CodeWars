...
function findChildren(santasList, children) {
    let arr=[];
    santasList.map(el => children.includes(el) ? arr.push(el) : []);
    arr.sort();
    return [...new Set(arr)];
}
console.log(findChildren(["Jason", "Jackson", "Jordan", "Johnny"],
    ["Jason", "Jordan", "Jennifer"]));
//["Jason", "Jordan"]
console.log(findChildren(["jASon", "JAsoN", "JaSON", "jasON"],
    ["JasoN", "jASOn", "JAsoN", "jASon", "JASON"]));
// ["JAsoN", "jASon"]
console.log(findChildren(["Jason", "James", "Johnson"],
    ["Jason", "James", "JJ"]));
// ["James", "Jason"]